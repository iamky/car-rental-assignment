  ...
  <div class="container-fluid">
    <div class="row">
      <div class="h-100 d-flex align-items-center justify-content-center align-middle">
        <input type="button" class="btn btn-primary" value="Customer" onclick="redirect(this)">
        <input type="button" class="btn btn-primary" value="Agency" onclick="redirect(this)">
      </div>
    </div>
  </div>
